...
if __name__ == '__main__':
  ...
  #parser.add_option('-i', '--image', dest="image", metavar="FILE", help="Use FILE as image instead of the one in the KML")
